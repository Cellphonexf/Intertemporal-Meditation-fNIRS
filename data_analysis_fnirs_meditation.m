%% fNIRS data analysis
%% Targeted to participants with meditation or mindfulness experiences
%% Required to run in MATLAB version R2017b
%% Required to load Homer3 processed data files
%% Programmed by Feng Xiao (2025.6.21)
clear all,
clc,
...
Mindfulness_first_subjs = [16 32 35 56];
Intertemporal_first_subjs = [17 33 52];
